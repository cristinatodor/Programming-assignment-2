document.addEventListener("DOMContentLoaded", function(event) {
	document.getElementById('get-see-do').addEventListener('click', async function(event){
		try {
			let responseTitles = await fetch('http://127.0.01:8090/list-see-titles');
			let responseDescriptions = await fetch('http://127.0.01:8090/list-see-descriptions');
			let responseImages = await fetch('http://127.0.01:8090/list-see-images');
	...
	window.addEventListener("load", async function(event){
		try {
			let response = await fetch('http://127.0.01:8090/about-location');
	...
	window.addEventListener("load", async function(event){
		try {
			let response = await fetch('http://127.0.01:8090/about-history');
	...
	window.addEventListener("load", async function(event){
		try {
			let response = await fetch('http://127.0.01:8090/about-population');
	...
	window.addEventListener("load", async function(event){
		try {
			let response = await fetch('http://127.0.01:8090/about-industry');
	...
	window.addEventListener("load", async function(event){
		try {
			let response = await fetch('http://127.0.01:8090/list-events');
	...
	function writeReviews(reviews) {
		...
		document.getElementById('review-title1').innerHTML = reviews[len-6].title;
		document.getElementById('review-author1').innerHTML = "Posted by " + reviews[len-6].author;
		document.getElementById('review-date1').innerHTML = reviews[len-6].date;
		document.getElementById('review-text1').innerHTML = reviews[len-6].text;
			
		document.getElementById('review-title2').innerHTML = reviews[len-5].title;
		document.getElementById('review-author2').innerHTML = "Posted by " + reviews[len-5].author;
		document.getElementById('review-date2').innerHTML = reviews[len-5].date;
		document.getElementById('review-text2').innerHTML = reviews[len-5].text;
			
		document.getElementById('review-title3').innerHTML = reviews[len-4].title;
		document.getElementById('review-author3').innerHTML = "Posted by " + reviews[len-4].author;
		document.getElementById('review-date3').innerHTML = reviews[len-4].date;
		document.getElementById('review-text3').innerHTML = reviews[len-4].text;
			
		document.getElementById('review-title4').innerHTML = reviews[len-3].title;
		document.getElementById('review-author4').innerHTML = "Posted by " + reviews[len-3].author;
		document.getElementById('review-date4').innerHTML = reviews[len-3].date;
		document.getElementById('review-text4').innerHTML = reviews[len-3].text;
			
		document.getElementById('review-title5').innerHTML = reviews[len-2].title;
		document.getElementById('review-author5').innerHTML = "Posted by " + reviews[len-2].author;
		document.getElementById('review-date5').innerHTML = reviews[len-2].date;
		document.getElementById('review-text5').innerHTML = reviews[len-2].text;
			
		document.getElementById('review-title6').innerHTML = reviews[len-1].title;
		document.getElementById('review-author6').innerHTML = "Posted by " + reviews[len-1].author;
		document.getElementById('review-date6').innerHTML = reviews[len-1].date;
		document.getElementById('review-text6').innerHTML = reviews[len-1].text;
	};
	window.addEventListener("load", async function(event){
		try {
			let response = await fetch('http://127.0.01:8090/list-reviews');
	...
	document.getElementById('get-eat').addEventListener('click', async function(event){
		try {
			let responseTitles = await fetch('http://127.0.01:8090/list-eat-titles');
			let responseDescriptions = await fetch('http://127.0.01:8090/list-eat-descriptions');
			let responseImages = await fetch('http://127.0.01:8090/list-eat-images');
	...
	document.getElementById('send-review').addEventListener('click', async function(event) {
		...
		try {
			...
			let response = await fetch('http://127.0.01:8090/add-review', 
											{
												method: "POST",
												headers: {
			...
			response = await fetch('http://127.0.01:8090/list-reviews');
...
/*document.getElementById('add-review').addEventListener('submit', async function(event){
  event.preventDefault();
